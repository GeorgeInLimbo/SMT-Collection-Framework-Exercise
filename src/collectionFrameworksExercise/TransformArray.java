 ...
 * <b>Description:</b>This class demonstrates how an Array can be converted to
 * an ArrayList. <br>
...
public class TransformArray {
	...
	/**
	 * This main method transforms an Array to an ArrayList and prints it to the
	 * console with a class method
	 * 
	 * @param args
	 */
